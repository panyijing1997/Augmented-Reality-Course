...
public class DogUnwarpping : MonoBehaviour
{
    public Camera cam;
    ...
    void Update()
    {
        ...
        if (camImg != null && camImg.Height > 0)
        {
           ...
           //Imgproc.circle(camImageMat, imgPnt1, 10, new Scalar(255, 0, 0, 200), 5);
            ...
            unwarpPoints.put(1, 0, 0, 512);
            unwarpPoints.put(2, 0, 512,512);
            unwarpPoints.put(3, 0, 512, 0);
            ...
            Imgproc.warpPerspective(texMat, dst1, Hinv, new Size(640, 480));

            Mat dst2 = new Mat(480, 640, CvType.CV_8UC4);
            Core.addWeighted(camImageMat, 0.99f, dst1, 0.2f, 0.0, dst2);
            ...
            MatDisplay.DisplayMat(dst2, MatDisplaySettings.FULL_BACKGROUND);
