...
public class Test1 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (camImg != null && camImg.Height > 0)
        {
            ...
            //For debug. Show if impPnti found the right position
            ...
            //For unwarpping
            MatOfPoint2f unwarpPoints; //corners after unwarpping
            unwarpPoints = new MatOfPoint2f();
            unwarpPoints.alloc(4);
            //according to the resolution
            unwarpPoints.put(0, 0, 0, 0);
            unwarpPoints.put(1, 0, 0, 236);
            unwarpPoints.put(2, 0, 442, 236);
            unwarpPoints.put(3, 0, 442, 0);
            //compute homography matrix
            Mat H = Calib3d.findHomography(imagePoints, unwarpPoints);
            Mat unwrapMat = new Mat(442, 236, CvType.CV_8UC4);
            Imgproc.warpPerspective(camImageMat, unwrapMat, H, new Size(442, 236));

            MatDisplay.MatToTexture(unwrapMat, ref tex);
            fishRd.material.mainTexture = tex;
